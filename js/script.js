       console.log('I can see the JavaScript file');

       // set up static variables
        // the dimensions of the visualization area
        var width = 1100,
           height = 550;
        ...
        var padding = 50;
        //data selections
        // Select div with id of graph append svg
        ...
        d3.csv('climate_data_truncated.csv', function(data) {
            ...
            tempScaleMax = d3.max(data, function(d){
                //TMAX returns a string, convert to integer
            ...
            // create two y axis, temp data and precipitation data
            viz.append('g')
